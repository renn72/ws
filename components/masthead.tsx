  ...
  return (
    ...
    >
      ...
      <div className='p-12 font-bold z-10 text-white drop-shadow-[0_5px_3px_rgba(0,0,0,0.4)] text-center flex-1 flex items-center justify-center flex-col'>
        <h1 className='mb-6 text-4xl xl:text-5xl'>Warner Systems</h1>
        <h2 className='mb-2 text-2xl xl:text-3xl tracking-tight'>
          <span>Web Developement,</span>{' '}<span>done right.</span>
        </h2>
      </div>
      <div className={`flex-grow-0 pb-20 md:pb-10 transition-all duration-1000 ${imageLoaded ? 'opacity-100' : 'opacity-0 -translate-y-10'}`}>
        <Image src='/assets/arrow-down.png' width={188 / 3} height={105 / 3} alt='scroll arrow-down' onLoadingComplete={handleImageLoaded} />
